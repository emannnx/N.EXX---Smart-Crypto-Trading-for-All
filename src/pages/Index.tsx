          ...
          <div className="grid lg:grid-cols-2 items-center justify-center w-full">
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl flex justify-center">
                <img
                  src={firstpageinmage}
                  alt="Professional crypto trader using modern trading "
            ...
            {services.map((service, index) => (
              ...
              >
                <Card className="h-full">
                  ...
                  <CardContent>
                    <CardDescription className="text-base md:text-lg text-muted-foreground mb-4 font-sans">{service.description}</CardDescription>
                  </CardContent>
                </Card>
              </motion.div>
            ))}
